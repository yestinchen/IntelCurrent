...
public class PullToRefreshListView extends ListView implements OnScrollListener{
	...
	private void init(Context context){
		 mFlipAnimation = new RotateAnimation(0, -180,
	        ...
	        mFlipAnimation.setDuration(350);
	        mFlipAnimation.setFillAfter(true);
	        mReverseFlipAnimation = new RotateAnimation(-180, 0,
	                RotateAnimation.RELATIVE_TO_SELF, 0.5f,
	                RotateAnimation.RELATIVE_TO_SELF, 0.5f);
	        mReverseFlipAnimation.setInterpolator(new LinearInterpolator());
	        mReverseFlipAnimation.setDuration(350);
        	...
        	mFootViewText.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(mFootViewText.getText().equals("获取更多")){
						mFootViewText.setText("加载中...");
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		  int visibleItemCount, int totalItemCount) {
		      ...
		      //判断底部是否为最后一个
//		        Log.v(TAG, "fist"+ firstVisibleItem+"visiable"+visibleItemCount+"total"+totalItemCount);
                if(firstVisibleItem + visibleItemCount == totalItemCount){
                	if(!hasFoot){
                		addFooterView(mFootViewText);
                		hasFoot = true;
                	}
//                }else if(hasFoot)	{
...
//                	hasFoot = false;
    ...
    public interface OnLoadMoreListener{
    	/**点击更多之后的动作
    	 * <p>
    	 * a call to {@link PullToRefresshListView #onLoadMoreComplete()} is 
    	 * expected to indicate that the load action has completed.*/
